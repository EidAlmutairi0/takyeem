...
class DoctorSiteInSearch extends StatefulWidget {
  @override
  _DoctorSiteInSearchState createState() => _DoctorSiteInSearchState();
}

class _DoctorSiteInSearchState extends State<DoctorSiteInSearch> {
  @override
                ...
                child: Column(
                  children: [
                    StreamBuilder<DocumentSnapshot>(
                      stream: _firestore
                          .collection("UNis")
                          .doc("$currentUniversityInSearch")
                          .collection("colleges")
                          .doc("$currentCollegeInSearch")
                          .collection("Doctors")
                          .doc("$currentDoctorInSearch")
                          .snapshots(),
                              ...
                              CupertinoDialogAction(
                                  onPressed: () {
                                    _firestore.collection("Complaints").add({
                                      ...
                                      "university": currentUniversityInSearch,
                                      "college": currentCollegeInSearch,
                                      "Dr": currentDoctorInSearch,
                                      "ID": widget.docID,
                                      "Rate1": rate1,
                                      "Rate2": rate2,
                                      "Rate3": rate3,
